...
if sys.prefix != str(_VENV_PATH):
    click.echo(f"❌ ERROR: Not using local virtual environment!", err=True)
...
from bpmn_agent.core.observability import ObservabilityManager, ObservabilityConfig, LogLevel
