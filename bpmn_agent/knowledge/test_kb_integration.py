...
def test_pattern_structure():
    ...
    patterns_dir = Path(__file__).parent / "patterns"
    required_fields = {
        "name", "description", "domain", "category", "complexity",
        "graph_structure", "examples", "validation_rules", 
        "anti_patterns", "tags", "confidence", "version"
    }
...
def test_example_structure():
    ...
    required_fields = {"text", "domain", "complexity", "pattern_id", "entities", "relations", "confidence", "source"}
...
def test_pattern_categories():
    ...
    expected_categories = {
        "sequential", "parallel", "exclusive_choice", "inclusive_choice",
        "multi_instance", "event_driven", "exception_handling", "data_flow"
    }
