...
class VectorSearchResult(BaseModel):
    ...
    item: Optional[Dict[str, Any]] = Field(None, description="The actual item (pattern or example)")
...
class VectorStore:
    ...
    def search_combined(
        ...
        """
        patterns = self.search_patterns(query, top_k=top_k_patterns, domain_filter=domain_filter)
        examples = self.search_examples(query, top_k=top_k_examples, domain_filter=domain_filter)
