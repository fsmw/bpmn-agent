...
class ValidationResultMapper:
    ...
    def merge_results(self, unified_result: UnifiedValidationResult) -> MergedValidationResult:
        """
    ...
    def to_dict(self, merged_result: MergedValidationResult) -> Dict[str, Any]:
        ...
        return {
            ...
            "info": [
                {"level": e.level, "category": e.category, "message": e.message, "source": e.source}
