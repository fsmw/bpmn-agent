...
def mock_llm_extraction_response():
    ...
    def _create_response(process_type="generic"):
        ...
        if process_type == "approval":
            return json.dumps({
                "entities": [
                    {"id": "actor_1", "name": "Employee", "type": "actor", "confidence": "high"},
                    {"id": "actor_2", "name": "Manager", "type": "actor", "confidence": "high"},
                    {"id": "actor_3", "name": "HR", "type": "actor", "confidence": "high"},
                    {"id": "task_1", "name": "submit request", "type": "activity", "confidence": "high"},
                    {"id": "task_2", "name": "review", "type": "activity", "confidence": "high"},
                    {"id": "task_3", "name": "process", "type": "activity", "confidence": "medium"},
                    {"id": "decision_1", "name": "decision", "type": "gateway", "confidence": "medium"},
                ],
                "relations": [
                    {"id": "rel_1", "source_id": "actor_1", "target_id": "task_1", "type": "involves", "confidence": "high"},
                    {"id": "rel_2", "source_id": "actor_2", "target_id": "task_2", "type": "involves", "confidence": "high"},
                    {"id": "rel_3", "source_id": "task_1", "target_id": "decision_1", "type": "precedes", "confidence": "medium"},
                    {"id": "rel_4", "source_id": "decision_1", "target_id": "task_3", "type": "precedes", "confidence": "medium"},
                ]
            })
            ...
            return json.dumps({
                "entities": [
                    ...
                    {"id": "task_1", "name": "receive order", "type": "activity", "confidence": "high"},
                    {"id": "task_2", "name": "validate inventory", "type": "activity", "confidence": "high"},
                    {"id": "task_3", "name": "check payment", "type": "activity", "confidence": "high"},
                    {"id": "task_4", "name": "pick items", "type": "activity", "confidence": "medium"},
                    {"id": "task_5", "name": "ship", "type": "activity", "confidence": "medium"},
                    {"id": "gateway_1", "name": "parallel fork", "type": "gateway", "confidence": "medium"},
                    {"id": "gateway_2", "name": "parallel join", "type": "gateway", "confidence": "medium"},
                ],
                "relations": [
                    {"id": "rel_1", "source_id": "actor_1", "target_id": "task_1", "type": "involves", "confidence": "high"},
                    {"id": "rel_2", "source_id": "task_1", "target_id": "gateway_1", "type": "precedes", "confidence": "high"},
                    {"id": "rel_3", "source_id": "gateway_1", "target_id": "task_2", "type": "precedes", "confidence": "medium"},
                    {"id": "rel_4", "source_id": "gateway_1", "target_id": "task_3", "type": "precedes", "confidence": "medium"},
                    {"id": "rel_5", "source_id": "task_2", "target_id": "gateway_2", "type": "precedes", "confidence": "medium"},
                    {"id": "rel_6", "source_id": "task_3", "target_id": "gateway_2", "type": "precedes", "confidence": "medium"},
                    {"id": "rel_7", "source_id": "gateway_2", "target_id": "task_4", "type": "precedes", "confidence": "medium"},
                    {"id": "rel_8", "source_id": "task_4", "target_id": "task_5", "type": "precedes", "confidence": "medium"},
                ]
            })
        else:  # generic
            return json.dumps({
                "entities": [
                    {"id": "actor_1", "name": "Customer", "type": "actor", "confidence": "high"},
                    {"id": "actor_2", "name": "System", "type": "actor", "confidence": "high"},
                    {"id": "task_1", "name": "submit order", "type": "activity", "confidence": "high"},
                    {"id": "task_2", "name": "process payment", "type": "activity", "confidence": "high"},
                    {"id": "task_3", "name": "ship order", "type": "activity", "confidence": "medium"},
                ],
                "relations": [
                    {"id": "rel_1", "source_id": "actor_1", "target_id": "task_1", "type": "involves", "confidence": "high"},
                    {"id": "rel_2", "source_id": "actor_2", "target_id": "task_2", "type": "involves", "confidence": "high"},
                    {"id": "rel_3", "source_id": "task_1", "target_id": "task_2", "type": "precedes", "confidence": "medium"},
                    {"id": "rel_4", "source_id": "task_2", "target_id": "task_3", "type": "precedes", "confidence": "medium"},
                ]
            })
...
def mock_llm_client(mock_llm_extraction_response):
    ...
    async def mock_call(messages, temperature=0.3, max_tokens=4096, **kwargs):
        ...
        if messages:
            ...
            # Debug logging
            import sys
            desc_preview = process_description[:200] if len(process_description) > 200 else process_description
            print(f"\n[MOCK DEBUG {call_count[0]}] Process description: {desc_preview}...", file=sys.stderr)
            
            content = process_description.lower()
            
            # Check for approval workflow
            if "approval" in content or "approve" in content or "reject" in content or "manager" in content:
                process_type = "approval"
            # Check for parallel workflow
            elif "parallel" in content or "inventory" in content or ("payment" in content and "inventory" in content):
                process_type = "parallel"
            
            print(f"[MOCK DEBUG {call_count[0]}] Detected process_type={process_type}\n", file=sys.stderr)
