...
from bpmn_agent.validation.rag_feedback_loop import RAGFeedbackLoop, PatternEffectivenessMetrics
...
class TestRAGFeedbackLoop:
    ...
    def test_record_validation_findings_single_pattern(self, sample_validation_result):
        ...
        feedback_loop.record_validation_findings(
            validation_result=sample_validation_result, patterns_applied=["pattern_1"]
        )
    ...
    def test_record_validation_findings_multiple_patterns(self, sample_validation_result):
        ...
        feedback_loop.record_validation_findings(
            validation_result=sample_validation_result, patterns_applied=["pattern_1", "pattern_2"]
        )
    ...
    def test_record_validation_findings_low_quality(self, sample_validation_result_low_quality):
        ...
        feedback_loop.record_validation_findings(
            validation_result=sample_validation_result_low_quality, patterns_applied=["pattern_1"]
        )
    ...
    def test_get_pattern_recommendations(self, sample_validation_result):
        ...
        recommendations = feedback_loop.get_pattern_recommendations(
            domain=DomainType.HR, max_recommendations=5
        )
...
class TestRAGFeedbackLoopIntegration:
    ...
    def test_multiple_recordings_accumulate(self):
        ...
        high_quality = XSDValidationResult(
            is_valid=True, quality_score=0.9, errors=[], warnings=[], suggestions=[]
        )

        low_quality = XSDValidationResult(
            is_valid=True, quality_score=0.7, errors=[], warnings=[], suggestions=[]
        )

        # Record high quality
        feedback_loop.record_validation_findings(
            validation_result=high_quality, patterns_applied=["pattern_1"]
        )

        # Record low quality
        feedback_loop.record_validation_findings(
            validation_result=low_quality, patterns_applied=["pattern_1"]
        )
