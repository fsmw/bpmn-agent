...
class TestValidationIntegrationLayer:
    ...
    def test_validate_xsd_only(
        self, mock_xsd_validator, sample_bpmn_xml, sample_xsd_result
    ):
    ...
    def test_validate_with_rag(
        self, mock_xsd_validator, mock_rag_validator, mock_feedback_loop,
        sample_bpmn_xml, sample_xsd_result, sample_rag_result, sample_process_graph
    ):
    ...
    def test_validate_records_feedback(
        self, mock_xsd_validator, mock_rag_validator, mock_feedback_loop,
        sample_bpmn_xml, sample_xsd_result
    ):
