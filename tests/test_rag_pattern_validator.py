...
def sample_process_graph():
    ...
    edges = [
        GraphEdge(id="Flow_1", source_id="StartEvent_1", target_id="Task_1", edge_type="sequenceFlow"),
        GraphEdge(id="Flow_2", source_id="Task_1", target_id="EndEvent_1", edge_type="sequenceFlow"),
    ]
...
class TestRAGPatternValidator:
    ...
    def test_initialization_with_kb(self, mock_knowledge_base, mock_pattern_bridge):
        ...
        validator = RAGPatternValidator(
            ...
            pattern_bridge=mock_pattern_bridge
        )
    ...
    def test_initialization_without_kb(self):
        ...
        with patch('bpmn_agent.validation.rag_pattern_validator.PatternLibraryLoader') as mock_loader:
    ...
    def test_validate_pattern_compliance_no_patterns(self, mock_knowledge_base, mock_pattern_bridge, sample_bpmn_xml):
    ...
    def test_validate_pattern_compliance_with_patterns(
        ...
        result = validator.validate_pattern_compliance(
            xml_content=sample_bpmn_xml,
            patterns_applied=["test_pattern_1"],
            domain="generic"
        )
    ...
    def test_get_pattern_by_id_found(self, mock_knowledge_base, mock_pattern_bridge, sample_bpmn_pattern):
    ...
    def test_validate_single_pattern(self, mock_knowledge_base, mock_pattern_bridge, sample_bpmn_xml, sample_bpmn_pattern, sample_process_graph):
    ...
    def test_validate_pattern_structure(self, mock_knowledge_base, mock_pattern_bridge, sample_bpmn_xml, sample_bpmn_pattern):
    ...
    def test_validate_pattern_elements(self, mock_knowledge_base, mock_pattern_bridge, sample_bpmn_xml, sample_bpmn_pattern):
    ...
    def test_validate_pattern_relations(self, mock_knowledge_base, mock_pattern_bridge, sample_process_graph, sample_bpmn_pattern):
    ...
    def test_validate_pattern_relations_no_graph(self, mock_knowledge_base, mock_pattern_bridge, sample_bpmn_pattern):
...
class TestRAGPatternValidatorIntegration:
    ...
    def test_validation_with_invalid_xml(self, mock_knowledge_base, mock_pattern_bridge, sample_bpmn_pattern):
