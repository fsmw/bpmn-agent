...
class Task(BaseElement):
    ...
    loop_characteristics: Optional[str] = Field(None, description="Loop type: standard/multiInstance")
...
class Process(BaseElement):
    ...
    # Associations
    associations: List[Association] = Field(default_factory=list, description="Non-control associations")
...
class Collaboration(BaseElement):
    ...
    conversation_links: List[Association] = Field(default_factory=list, description="Conversation links")
...
class Definitions(BaseElement):
    ...
    item_definitions: List[ItemDefinition] = Field(default_factory=list, description="Item definitions")
...
class BPMNDiagram:
    ...
    def validate_cross_references(self) -> tuple[bool, List[str]]:
        ...
        for process in self.definitions.processes:
            ...
            for data_store in process.data_stores:
                if data_store.item_subject_ref and data_store.item_subject_ref not in all_element_ids:
                    errors.append(
