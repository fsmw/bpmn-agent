...
from bpmn_agent.core.llm_client import BaseLLMClient, LLMConfig
...
class EntityExtractor:
    ...
    async def extract_from_text(
        ...
        try:
            ...
            if not parsed_data:
                raise ValueError(f"Failed to extract JSON after {max_retries + 1} attempts: {last_error}")
        ...
        confidence_counts = {
            ...
            ConfidenceLevel.MEDIUM: sum(1 for e in entities if e.confidence == ConfidenceLevel.MEDIUM),
        ...
        relation_confidence_counts = {
            ...
            ConfidenceLevel.MEDIUM: sum(1 for r in relations if r.confidence == ConfidenceLevel.MEDIUM),
